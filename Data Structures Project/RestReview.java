...
public class RestReview extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == cmbMessageList7) {
			...
			//ResUtility RU=new ResUtility();
			//System.out.println(RU.getShortName2(indexString));
			ResRating RR = new ResRating("pizzahut");
			...
			if (resString.equals("Print All Reviews")) {
				...
				try {
					...
					newWindow correct = new newWindow(RU.getShortName2((String) cmbMessageList2.getSelectedItem()));
